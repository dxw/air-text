module AirQualitySteps
  def given_an_air_pollution_prediction_for_today_w_high_warning_status
    forecasts << Fixtures::API.zone_forecast(day: :today, air_pollution_status: :high)
  end

  def and_an_air_pollution_prediction_for_tomorrow_w_moderate_warning_status
    forecasts << Fixtures::API.zone_forecast(day: :tomorrow, air_pollution_status: :moderate, daqi_value: 4)
  end

  def and_an_air_pollution_prediction_for_day_after_tomorrow_w_v_high_warning_status
    forecasts << Fixtures::API.zone_forecast(day: :day_after_tomorrow, air_pollution_status: :very_high, daqi_value: 10)
  end

  def given_an_air_pollution_prediction_for_today_w_low_status
    forecasts << Fixtures::API.zone_forecast(day: :today, air_pollution_status: :low)
  end

  def and_an_air_pollution_prediction_for_tomorrow_w_low_warning_status
    forecasts << Fixtures::API.zone_forecast(day: :tomorrow, air_pollution_status: :low)
  end

  def and_an_air_pollution_prediction_for_day_after_tomorrow_w_low_warning_status
    forecasts << Fixtures::API.zone_forecast(day: :day_after_tomorrow, air_pollution_status: :low)
  end
